...
export const payments: Payment[] = [
  ...
  { id: 'pay-18', residentId: 'r-14', residentName: 'Yuki Taniguchi', unitNumber: '3B', propertyId: 'prop-2', amount: 2100, type: 'rent', status: 'paid', dueDate: '2026-03-01', paidDate: '2026-02-27' },
  { id: 'pay-19', residentId: 'r-15', residentName: 'Fatima Hassan', unitNumber: '5A', propertyId: 'prop-2', amount: 2200, type: 'rent', status: 'pending', dueDate: '2026-03-01' },
  { id: 'pay-20', residentId: 'r-16', residentName: 'Daniel Park', unitNumber: '7C', propertyId: 'prop-2', amount: 2500, type: 'rent', status: 'paid', dueDate: '2026-03-01', paidDate: '2026-02-26' },
  { id: 'pay-21', residentId: 'r-17', residentName: 'Nina Petrova', unitNumber: '9A', propertyId: 'prop-2', amount: 2700, type: 'rent', status: 'pending', dueDate: '2026-03-01' },
  ...
  { id: 'pay-22', residentId: 'r-11', residentName: 'Michael Brown', unitNumber: '1A', propertyId: 'prop-2', amount: 2000, type: 'rent', status: 'paid', dueDate: '2026-02-01', paidDate: '2026-01-31' },
  { id: 'pay-23', residentId: 'r-14', residentName: 'Yuki Taniguchi', unitNumber: '3B', propertyId: 'prop-2', amount: 2100, type: 'rent', status: 'overdue', dueDate: '2026-02-01' },
  ...
  { id: 'pay-24', residentId: 'r-16', residentName: 'Daniel Park', unitNumber: '7C', propertyId: 'prop-2', amount: 75, type: 'fee', status: 'paid', dueDate: '2026-02-10', paidDate: '2026-02-10' },
];
